...
var RoleManagerAbiMetaData = &bind.MetaData{
...
// RoleManagerAbiABI is the input ABI used to generate the binding from.
// Deprecated: Use RoleManagerAbiMetaData.ABI instead.
var RoleManagerAbiABI = RoleManagerAbiMetaData.ABI
...
func bindRoleManagerAbi(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := RoleManagerAbiMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
