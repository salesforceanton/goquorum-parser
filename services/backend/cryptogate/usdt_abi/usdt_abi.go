...
var UsdtAbiMetaData = &bind.MetaData{
...
// UsdtAbiABI is the input ABI used to generate the binding from.
// Deprecated: Use UsdtAbiMetaData.ABI instead.
var UsdtAbiABI = UsdtAbiMetaData.ABI
...
func bindUsdtAbi(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := UsdtAbiMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
