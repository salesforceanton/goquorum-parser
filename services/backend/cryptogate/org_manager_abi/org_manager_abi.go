...
var OrgManagerAbiMetaData = &bind.MetaData{
...
// OrgManagerAbiABI is the input ABI used to generate the binding from.
// Deprecated: Use OrgManagerAbiMetaData.ABI instead.
var OrgManagerAbiABI = OrgManagerAbiMetaData.ABI
...
func bindOrgManagerAbi(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := OrgManagerAbiMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
