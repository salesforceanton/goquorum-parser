...
var PermissionsImplAbiMetaData = &bind.MetaData{
...
// PermissionsImplAbiABI is the input ABI used to generate the binding from.
// Deprecated: Use PermissionsImplAbiMetaData.ABI instead.
var PermissionsImplAbiABI = PermissionsImplAbiMetaData.ABI
...
func bindPermissionsImplAbi(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := PermissionsImplAbiMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
