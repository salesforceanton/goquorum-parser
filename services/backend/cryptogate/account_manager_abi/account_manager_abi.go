...
var AccountManagerAbiMetaData = &bind.MetaData{
...
// AccountManagerAbiABI is the input ABI used to generate the binding from.
// Deprecated: Use AccountManagerAbiMetaData.ABI instead.
var AccountManagerAbiABI = AccountManagerAbiMetaData.ABI
...
func bindAccountManagerAbi(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := AccountManagerAbiMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
